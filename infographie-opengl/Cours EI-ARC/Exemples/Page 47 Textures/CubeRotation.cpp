...
*/
/*
  // Que du noir, on ne mappe que la partie inférieure gauche
	glBegin(GL_QUADS);
		glTexCoord2f(0,0);glVertex3i(-1,-1,+1);
		glTexCoord2f(0.5,0);glVertex3i(+1,-1,+1);
		glTexCoord2f(0.5,0.5);glVertex3i(+1,+1,+1);
		glTexCoord2f(0,0.5);glVertex3i(-1,+1,+1);
	glEnd();
*/
/*
  // Damier répété plusieurs fois
	glBegin(GL_QUADS);
		glTexCoord2f(0,0);glVertex3i(-1,-1,+1);
		glTexCoord2f(10,0);glVertex3i(+1,-1,+1);
		glTexCoord2f(10,10);glVertex3i(+1,+1,+1);
		glTexCoord2f(0,10);glVertex3i(-1,+1,+1);
	glEnd();
*/
