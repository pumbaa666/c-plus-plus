...
//    gluTessCallback(tobj, GLU_END, glEnd);
    gluTessCallback(tobj, GLU_TESS_BEGIN,
                    reinterpret_cast<GLvoid (CALLBACK *)()>(&glBegin));
    gluTessCallback(tobj, GLU_TESS_VERTEX,
                    reinterpret_cast<GLvoid (CALLBACK *)()>(&glVertex2fv));
    gluTessCallback(tobj, GLU_TESS_END,
                    reinterpret_cast<GLvoid(CALLBACK *)()>(&glEnd));
  }
...
main(int argc, char **argv)
{
  ...
  glutCreateWindow("Bouton droit de la souris pour menu");
