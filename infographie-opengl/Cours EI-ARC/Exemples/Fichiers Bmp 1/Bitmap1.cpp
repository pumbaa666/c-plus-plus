 ...
 *************************************************************
 *   06. 01. 2006 : PCH
 *    Pour linker avec ce fichier, il faut ajouter :
 *    -lcomdlg32
 *    dans Options du projet / Paramètres
 *    Cette librairie est nécessaire à cause de la fonction
 *    PrintDlg(...)
 *    qui est appelée dans : PrintDIBitmap
 *
 * Changer le nom du fichier :
 * Bitmap.cpp  --> Bitmap1.cpp
 *
 *************************************************************
 *   17. 01. 2005 : PCH
 *   Remplacer if(header.bfType != 'MB')
 *   par :     if(header.bfType != 19778)
 *    et :      header.bfType = 'MB'
 *    par :     header.bfType = 19778;
 *************************************************************
 *   $Log: bitmap.c,v $
             ...
             BITMAPINFO	**info)		/* O - Bitmap information */
{
  ...
  */
  ...
  if (header.bfType != 19778 /*'MB'*/)	/* Check for BM reversed... */
  {
   /*
             ...
             void       *bits)		/* I - Bitmap pixel bits */
{
  ...
  */
  ...
  header.bfType      = 19778; /*'MB';*/		/* Non-portable... sigh */
  header.bfSize      = size;
