...
// L'objet tourne, mais pas la lumière.
...
void display()  // Lumière relative au point de vue
{
   ...
   gluLookAt(0,3,3,0,0,0,0,1,0);  // Position de la caméra après la lampe
