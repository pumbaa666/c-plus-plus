...
/* GLUT 3.7.6
   Modifier par Pierre Chatelain le 7. 8. 2002 pour utilisation
   avec Borland C.
   Lignes 63, 71, 72, 73, 74 */
...
/* CN, 7. 8. 2002 #  pragma comment (lib, "winmm.lib")      /* link with Windows MultiMedia lib */
...
#  else
/* CN, 7. 8. 2002  #   pragma comment (lib, "opengl32.lib")  /* link with Microsoft OpenGL lib */
/* CN, 7. 8. 2002  #   pragma comment (lib, "glu32.lib")     /* link with Microsoft OpenGL Utility lib */
/* CN, 7. 8. 2002  #   pragma comment (lib, "glut32.lib")    /* link with Win32 GLUT lib */
#   pragma comment (lib, "glut32imp.lib") /* link avec glut32 importation, CN, 7. 8. 2002 */
#  endif
# endif
