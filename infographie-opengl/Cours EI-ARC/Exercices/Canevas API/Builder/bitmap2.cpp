...
* Bitmap.cpp  --> Bitmap2.cpp
*
* 17. 01 2005 :   PCH
* Remplacer : if (header.bfType != 'MB')
* par       : if (header.bfType != BF_TYPE )
* et
*           : header.bfType      = 'MB';
* par       : header.bfType      = BF_TYPE;
*/
             ...
             BITMAPINFO **info)    /* O - Bitmap information */
{
    ...
    if (header.bfType != BF_TYPE /*'MB'*/)	/* Check for BM reversed... */
        {
...
SaveDIBitmap(const char *filename, /* I - File to load */
    ...
    header.bfType      = BF_TYPE /*'MB'*/; /* Non-portable... sigh */
    header.bfSize      = size;
...
unsigned char /*GLubyte*/ *                          /* O - Bitmap data */
LoadDIBitmap(const char *filename, /* I - File to load */
             BITMAPINFO **info)    /* O - Bitmap information */
    {
    FILE             *fp;          /* Open file pointer */
    unsigned char /*GLubyte*/          *bits;        /* Bitmap pixel bits */
    unsigned char /*GLubyte*/          *ptr;         /* Pointer into bitmap */
    unsigned char /*GLubyte*/          temp;         /* Temporary variable to swap red and blue */
...
SaveDIBitmap(const char *filename, /* I - File to load */
             BITMAPINFO *info,     /* I - Bitmap information */
	     unsigned char /*GLubyte*/    *bits)     /* I - Bitmap data */
    {
    FILE *fp;                      /* Open file pointer */
    int  size,                     /* Size of file */
         infosize,                 /* Size of bitmap info */
