                    ...
                    int bits, bool fullscreenflag)
{
  ...
  int PixelFormat;		// Holds The Results After Searching For A Match
	...
	wc.hIcon         = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_MYICON)); //IDI_WINLOGO);			// Load The Default Icon
	wc.hIconSm       = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_MYICON)); //IDI_APPLICATION);
	...
	if (fullscreen)												// Attempt Fullscreen Mode?
	{
		...
		if (ChangeDisplaySettings(&dmScreenSettings,CDS_FULLSCREEN)!=DISP_CHANGE_SUCCESSFUL)
		{
			...
			if (MessageBox(NULL,"The Requested Fullscreen Mode Is Not Supported By\nYour Video Card. Use Windowed Mode Instead?","Fullscreen Mode",MB_YESNO|MB_ICONEXCLAMATION)==IDYES)
			{
