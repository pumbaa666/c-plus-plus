...
* Texture.cpp  --> Texture2.cpp
*
* 17. 01. 2005 : PCH
* Remplacer : glTexEnvi(GL_TEXTURE_ENV, GL_TEXTURE_ENV_MODE, GL_REPLACE);
* par       : glTexEnvi(GL_TEXTURE_ENV, GL_TEXTURE_ENV_MODE, GL_MODULATE);
*
*/
 ...
 *
 * Returns : Texture object or 0 on error
 */
