...
GLfloat	 lightPos[] = { DistanceLumiere, 15.0f, 0.0f, 0.0f };
...
// Plan de projection de l'ombre à 0.05 de hauteur à cause du Depth Buffer
/*
GLfloat vfloor2[4][3] = { {-100, 0.05,  100},
                          { 100, 0.05,  100},
                          { 100, 0.05, -100},
                          {-100, 0.05, -100} };
*/
